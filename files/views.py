...
class FolderViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated]  # Changed from IsHR to allow all authenticated users to view
    ...
    def perform_destroy(self, instance):
        ...
        try:
            ...
            print(f"Deleting folder {instance.id} and {len(folder_ids)-1} descendants")
            
            # Delete all files in these folders
            deleted_files = File.objects.filter(folder_id__in=folder_ids).delete()
